...
def add_state_to_map(state_name):
    ...
    new_state.write(answer_state)   # Or just get answer state as its also the raw value, but formatted and titlecased
...
def missed_states(correct_guesses, states_names):
    ...
    states_to_learn.to_csv("Days\\Day 25\\Project - US States Game\\states_to_learn.csv")


states_data = pandas.read_csv("Days\\Day 25\\Project - US States Game\\50_states.csv")
correct_guesses = []
