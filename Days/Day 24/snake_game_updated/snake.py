...
class Snake():
    ...
    def create_snake(self):
        ...
        print(self.segments[1].pos())
        print(self.segments[2].pos())
    ...
    def reset(self):
        for seg in self.segments:   # Clear segments to make way for new ones
            seg.goto(1000, 1000)
        self.segments.clear()       # Get rid of segments from list
        self.create_snake()         # Create new segments
